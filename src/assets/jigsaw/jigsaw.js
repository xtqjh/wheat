...
(function (window) {
  ...
  function getRandomImg() {
    ...
    return './assets/jigsaw/img/150 (' + getRandomNumberByRange(1, 104) + ').jpg'
  }
  ...
  class jigsaw {
    ...
    bindEvents() {
      ...
      const handleDragMove = (e) => {
        ...
        if (moveX < 0 || moveX + 30 >= w) return false
        this.slider.style.left = moveX + 'px'
        const blockLeft = (w - 32 - 20) / (w - 32) * moveX
